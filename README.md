...
- 💳 **Full-Stack Expense Tracker App**
  - **Description:** Developing a comprehensive financial tracking application featuring real-time data input, custom spending analytics, and secure data storage.
  - **Tech Stack:** 🐍 Python, 🎸 Django, 🟨 JavaScript, 🌐 HTML5 / CSS3

---

### 🚀 Featured Projects
*(Note: These repositories are currently set to **Private**, but the systems are fully implemented and functional).*

#### 🎫 Customer Ticket ML Classifier
- **Description:** A production-ready full-stack application that automates corporate IT ticket triage by predicting both category and priority from text inputs.
